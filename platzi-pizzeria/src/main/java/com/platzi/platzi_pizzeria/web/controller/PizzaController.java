...
//    }
    ...
    public Page<PizzaEntity> getAllPizzaPaginado(@RequestParam(defaultValue = "1") int page, @RequestParam(defaultValue = "10") int element) {
        return this.pizzaService.getAllPizzaPaginado(page, element);
    }

    @GetMapping("ordenamiento")
    public Page<PizzaEntity> getAllPizzaPagOrdenado(@RequestParam(defaultValue = "1") int page ,
                                                    @RequestParam(defaultValue = "10") int element,
